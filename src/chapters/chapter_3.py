...
def start_chapter_3():
    ...
    print("\n")
    print("--------------------")
    print(Fore.WHITE + Back.BLUE + "Chapter 3 -- Afternoon".upper())
    print("----------------------")
